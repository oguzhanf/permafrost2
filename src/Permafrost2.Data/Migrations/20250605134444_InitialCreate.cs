        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Criticality = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataCollectionRuns_DataSources_DataSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationPermissions", x => new { x.ApplicationId, x.PermissionId, x.PrincipalId, x.PrincipalType });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataCollectionRuns_DataSourceId",
