...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Permafrost2.Data.Models.AgentCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Permafrost2.Data.Models.AgentError", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AgentId", "ErrorId")
                        .IsUnique();

                    b.HasIndex("Severity", "Category");

                    b.ToTable("AgentErrors");
                });

            modelBuilder.Entity("Permafrost2.Data.Models.AgentErrorReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DuplicateErrorCount")
                        .HasColumnType("int");

                    b.Property<int>("NewErrorCount")
                        .HasColumnType("int");

                    b.Property<DateTime>("ProcessedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("ProcessedErrorCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Permafrost2.Data.Models.AgentCertificate", b =>
                {
                    b.HasOne("Permafrost2.Data.Models.Agent", "Agent")
                        .WithMany()
